...
Based on the screenshots and the standard mechanics of this game genre (4X Space Strategy MMOs like _Galaxy Empire_ or _OGame_), here is the breakdown of the universe structure.
...
- **Conclusion:** While there are 8 distinct _visual themes_ shown, the game likely supports **multiple numbered galaxies** (e.g., Galaxy 1 through Galaxy 9, or even more), cycling through these visual themes.
...
Based on the standard mechanics of this specific game genre (which closely mirrors _OGame_ and _Galaxy Empire_), here is how planet ownership works:
...
Based on the standard tech trees of games in this genre (like _OGame_ or _Galaxy Empire_), research is typically divided into four categories: **Basic**, **Drive (Engines)**, **Advanced**, and **Combat**.
...
- **Tapping an Occupied Planet:** Opens a **Mission Menu** with options:
  - _Espionage:_ Send probes to see resources/defenses.
  - _Attack:_ Send fleet to raid.
  - _Transport:_ Send resources to allies.
  - _Message:_ Open chat with the owner.
