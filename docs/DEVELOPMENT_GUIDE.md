...
- _Note_: The original `AGENTS.md` was tailored for a PocketBase expert. Since this project is PostgreSQL + SvelteKit, rely on the Schema section above and standard SQL practices.
