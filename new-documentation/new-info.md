This video is a **comprehensive tutorial by Prismic** titled *"SvelteKit Crash Course: Build a Full Website in 90 min!"*. It walks you through building a dynamic, production-ready marketing website from scratch using SvelteKit and a Headless CMS (Prismic).
...
*The tech stack and SvelteKit-specific features used.*
