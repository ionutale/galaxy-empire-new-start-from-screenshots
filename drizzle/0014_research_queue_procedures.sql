...
BEGIN
    ...
    LOOP
        ...
        SELECT user_id, completed_research.research_type_id, completed_research.level
        WHERE NOT EXISTS (
        ...
        BEGIN
            IF prereq_type LIKE 'research_%' THEN
                ...
                BEGIN
                    ...
                    WHERE user_id = user_id AND research_type_id = req_research_id;
                END;
            ELSIF prereq_type LIKE 'building_%' THEN
                ...
                BEGIN
                    ...
                    WHERE p.user_id = user_id AND pb.building_type_id = req_building_id;
                END;
            ELSE
