...
describe('Advanced Game Features', () => {
  ...
  describe('Ship Statistics', () => {
    it('should have all ship types with correct stats', async () => {
      const result = await db.execute(sql`SELECT * FROM game_ship_stats WHERE category = 'ship' ORDER BY ship_type`);
    ...
    it('should have all defense types with correct stats', async () => {
      const result = await db.execute(sql`SELECT * FROM game_ship_stats WHERE category = 'defense' ORDER BY ship_type`);
  ...
  describe('Combat Simulation', () => {
    ...
    it('should have test results in procedure_tests table', async () => {
      const result = await db.execute(sql`SELECT * FROM procedure_tests WHERE procedure_name = 'simulate_combat'`);
