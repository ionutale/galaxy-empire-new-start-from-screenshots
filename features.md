...
*   **Player Profiles:** Avatars and ranks (e.g., "Uno", "John...").
...
*   **Commander/Avatar:** Character portraits (anime/semi-realistic style) representing the player.
